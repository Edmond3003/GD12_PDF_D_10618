package com.example.gd12_pdf_d_10618
...
import com.example.gd12_pdf_d_10618.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    private fun createPdf(nama: String, umur: String, tlp: String, alamat: String, kampus: String) {
        ...
        val file = File(pdfPath, "pdf_10618.pdf")
        ...
        @SuppressLint("UseCompatLoadingForDrawables") val d =getDrawable(R.drawable.holmes)
